...
Through my research, however, I stumbled across a couple of potential energy tracking solutions.
...
This means that the measuring approach above would only work if you *never* used your laptop while it was plugged into wall chargers -- you'd essentially need to keep your laptop shut down while charging, and only have it turned on while on battery power. Obviously, this is not very realistic.
...
/usr/sbin/ioreg -rw0 -c AppleSmartBattery | \  # retrieve power data
  ...
  xargs -I %  lldb --batch -o "print/f %" | \  # convert power info into an IEEE 754 floating point value
  grep -o '$0 = [0-9.]*' | \                   # extract only the numbers
  cut -c 6-                                    # remove the formatting
```

This number is the amount of watts currently being consumed by your laptop. In order to turn this value into a usable energy consumption metric, you have to sample it over time. After thinking this through, here was the logging format I came up with to make tracking energy consumption simple:
...
```text
timestamp=2022-01-30T23:41:00Z wattage=8.37764739 wattHours=.13962745650000000000 uuid=EDD819A5-1409-5797-9BE4-22EAAC75D458
timestamp=2022-01-30T23:42:01Z wattage=8.7869072 wattHours=.14644845333333333333 uuid=EDD819A5-1409-5797-9BE4-22EAAC75D458
timestamp=2022-01-30T23:43:00Z wattage=9.16559505 wattHours=.15275991750000000000 uuid=EDD819A5-1409-5797-9BE4-22EAAC75D458
timestamp=2022-01-30T23:44:00Z wattage=8.49206352 wattHours=.14153439200000000000 uuid=EDD819A5-1409-5797-9BE4-22EAAC75D458
timestamp=2022-01-30T23:45:00Z wattage=7.45262718 wattHours=.12421045300000000000 uuid=EDD819A5-1409-5797-9BE4-22EAAC75D458
```
